...
class EKF():
    ...
    def kalman_update(self):
        # TODO
        """
            denna funktion uppdaterar till nästa state
            och går igenom alla steg som skrivits i anteckningar.

            Möjligtvis gör detta i uppdate funktionen
        """
        pass
    ...
    def predict_cov(self):
        ...
        self._P = F_k @ self._P @ np.transpose(F_k) + Q_k
    ...
    def get_theta(self):
        # TODO
        # write function that gets angle of lawnmower (Z_k)
        pass
